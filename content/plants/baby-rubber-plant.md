---
title: 'Mastering Care for Your Baby Rubber Plant: A Comprehensive Guide'
...
1. **Check Soil Moisture**: Insert a finger about an inch into the soil. If it feels dry, it's time to water.
2. **Use Room Temperature Water**: Avoid using cold water as it can shock the roots.
3. **Water Thoroughly**: Ensure the entire root ball is moist by pouring water until it drains from the bottom of the pot.
...
1. **Select Healthy Cuttings**: Choose stem tips with at least two nodes.
2. **Prepare Soil**: Use a well-draining medium like perlite or sand.
3. **Place Cuttings in Soil**: Insert the bottom node of each cutting into the soil mix.
4. **Provide Humidity**: Cover the container with a clear plastic bag to maintain high humidity levels.
5. **Wait for Roots**: Rooting should occur within 2-4 weeks. Once roots are established, transplant into individual pots.
